...
public interface FavoriteService_23110229 {
    List<Favorite_23110229> findAll_23110229();

    Optional<Favorite_23110229> findById_23110229(Integer favoriteId_23110229);

    Favorite_23110229 save_23110229(Favorite_23110229 favorite_23110229);

    void deleteById_23110229(Integer favoriteId_23110229);
